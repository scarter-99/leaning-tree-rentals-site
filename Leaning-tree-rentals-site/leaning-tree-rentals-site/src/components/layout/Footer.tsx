      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-[var(--color-gray-400)] mb-4">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link
                href="/reserve"
                className="text-[var(--color-primary-light)] hover:text-white font-semibold transition-colors"
              >
                Book a Reservation
              </Link>
            </nav>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[var(--color-primary-light)] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <div>
                  <a
                    href={`tel:${CONTACT_INFO.phone}`}
                    className="text-white hover:text-[var(--color-primary-light)] font-medium transition-colors"
                  >
                    {CONTACT_INFO.phone}
                  </a>
