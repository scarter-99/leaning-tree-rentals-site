          ...
          <div className="card bg-white">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span>All reservations are first come, first serve. Reserve early to secure your preferred date and time.</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="font-medium">No refunds - No exceptions. Please review our <Link href="/policies" className="text-[var(--color-primary)] hover:underline">rental policies</Link> before reserving.</span>
              </li>
            </ul>
          </div>
        </div>
